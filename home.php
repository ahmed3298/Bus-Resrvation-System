	...
	<head>
		...
		<div class="conatiner-fluid">
			...
			<div class="col-lg-4">
			  ...
			  <p>
     			Safe, Affordable, Accessible
       			Founded in 2023, AA Express bus service is the largest provider of intercity and urban bus transportation, serving more than 15,000 destinations with 150,000 daily departures across Pakistan</p></div>
			...
			<div class="col-lg-4 text-left"> 
				...
				<div id="booking">
					<a href="passenger_detail.php" class="btn btn-lg btn-info btn-block">Book Seat</a>
				</div>
			</div>
			<div>
