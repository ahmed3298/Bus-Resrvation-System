...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1360054811127925"
     crossorigin="anonymous"></script>
		...
		<div class="conatiner-fluid">
			...
			<div class="col-lg-4 text-left"> 
				...
				<div id="booking">
					<a href="login.php" class="btn btn-lg btn-info btn-block">Book Seat</a>
				</div>
			</div>
			<div>
